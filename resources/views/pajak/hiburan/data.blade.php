<table class="table table-hover mb-0">
  <thead class="bg-light bg-opacity-50">
    ...
    <tbody>
      @php
          $no = ($pajakhiburan->currentPage() - 1) * $pajakhiburan->perPage() + 1;
      @endphp
      @foreach ($pajakhiburan as $item)
        <tr>
          ...
          <td class="text-center">
            ...
            <a href="{{ route('laporan.hiburan.index', ['id'=> $item->id]) }}" class="btn btn-sm btn-success" data-bs-toggle="tooltip" title="Lihat Detail Pajak">
