<table class="table table-hover mb-0">
  <thead class="bg-light bg-opacity-50">
    ...
    <tbody>
      @php
          $no = ($pajakrestoran->currentPage() - 1) * $pajakrestoran->perPage() + 1;
      @endphp
      @foreach ($pajakrestoran as $item)
        <tr>
          ...
          <td class="text-center">
            ...
            <a href="{{ route('laporan.restoran.index', ['id'=> $item->id]) }}" class="btn btn-sm btn-success" data-bs-toggle="tooltip" title="Lihat Detail Pajak">
