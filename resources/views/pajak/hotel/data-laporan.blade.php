        ...
        @foreach ($laporan as $item)
            ...
            <tr>
                ...
                <td style="text-align:center;">
                    ...
                    <a href="{{ route('laporan.hotel.pemberitahuan.download', ['id'=> $item->id]) }}" class="badge rounded-pill bg-success p-2" style="text-decoration: none" target="_blank" data-bs-toggle="tooltip" title="Download Surat Pemberitahuan">
                        Download
                    </a>
                    @else
                ...
                <td style="text-align:center;">
                    ...
                    <a href="{{ route('laporan.hotel.teguran.download', ['id'=> $item->id]) }}" class="badge rounded-pill bg-success p-2" style="text-decoration: none" target="_blank" data-bs-toggle="tooltip" title="Download Surat Teguran">
                        Download
                    </a>
                    @else
                        <div class="badge rounded-pill text-secondary p-2">
